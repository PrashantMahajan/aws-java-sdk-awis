...
@XmlRootElement(name = "UrlInfoResponse")
public class UrlInfoResponse {

    @XmlElement(name = "Response", required = true)
    protected UrlInfoResponse.Response response;
     ...
     * @return
     *     possible object is
     *     {@link UrlInfoResponse.Response }
     *     
     */
    public UrlInfoResponse.Response getResponse() {
        return response;
    }
     ...
     *     
     */
    public void setResponse(UrlInfoResponse.Response value) {
        this.response = value;
    }
    ...
    public static class Response {
        ...
        @XmlElement(name = "UrlInfoResult")
        protected List<UrlInfoResult> urlInfoResult;
         ...
         * not a snapshot. Therefore any modification you make to the
         * returned list will be present inside the JAXB object.
         * This is why there is not a <CODE>set</CODE> method for the urlInfoResult property.
         * 
         * <p>
         * For example, to add a new item, do as follows:
         * <pre>
         *    getUrlInfoResult().add(newItem);
         * </pre>
         * 
         * 
         * <p>
         ...
         * 
         */
        public List<UrlInfoResult> getUrlInfoResult() {
            if (urlInfoResult == null) {
                urlInfoResult = new ArrayList<UrlInfoResult>();
            }
            return this.urlInfoResult;
        }
