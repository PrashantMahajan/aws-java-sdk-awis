...
@XmlRootElement(name = "CrawlResponse")
public class CrawlResponse {

    @XmlElement(name = "Response", required = true)
    protected CrawlResponse.Response response;
     ...
     * @return
     *     possible object is
     *     {@link CrawlResponse.Response }
     *     
     */
    public CrawlResponse.Response getResponse() {
        return response;
    }
     ...
     *     
     */
    public void setResponse(CrawlResponse.Response value) {
        this.response = value;
    }
    ...
    public static class Response {
        ...
        @XmlElement(name = "CrawlResult")
        protected List<CrawlResult> crawlResult;
        ...
        /**
         * Gets the value of the crawlResult property.
         * 
         * <p>
         * This accessor method returns a reference to the live list,
         * not a snapshot. Therefore any modification you make to the
         * returned list will be present inside the JAXB object.
         * This is why there is not a <CODE>set</CODE> method for the crawlResult property.
         * 
         * <p>
         * For example, to add a new item, do as follows:
         * <pre>
         *    getCrawlResult().add(newItem);
         * </pre>
         * 
         * 
         * <p>
         ...
         * 
         */
        public List<CrawlResult> getCrawlResult() {
            if (crawlResult == null) {
                crawlResult = new ArrayList<CrawlResult>();
            }
