...
@XmlRootElement(name = "CategoryBrowseResponse")
public class CategoryBrowseResponse {

    @XmlElement(name = "Response", required = true)
    protected CategoryBrowseResponse.Response response;
     ...
     * @return
     *     possible object is
     *     {@link CategoryBrowseResponse.Response }
     *     
     */
    public CategoryBrowseResponse.Response getResponse() {
        return response;
    }
     ...
     *     
     */
    public void setResponse(CategoryBrowseResponse.Response value) {
        this.response = value;
    }
    ...
    public static class Response {
        ...
        @XmlElement(name = "CategoryBrowseResult")
        protected List<CategoryBrowseResult> categoryBrowseResult;
        ...
        /**
         * Gets the value of the categoryBrowseResult property.
         * 
         * <p>
         * This accessor method returns a reference to the live list,
         * not a snapshot. Therefore any modification you make to the
         * returned list will be present inside the JAXB object.
         * This is why there is not a <CODE>set</CODE> method for the categoryBrowseResult property.
         * 
         * <p>
         * For example, to add a new item, do as follows:
         * <pre>
         *    getCategoryBrowseResult().add(newItem);
         * </pre>
         * 
         * 
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link CategoryBrowseResult }
         * 
         * 
         */
        public List<CategoryBrowseResult> getCategoryBrowseResult() {
            if (categoryBrowseResult == null) {
                categoryBrowseResult = new ArrayList<CategoryBrowseResult>();
            }
